    ...
    <div className= {`navbar fixed w-full transition-all ${scrollActive}`}>
      <div className="container mx-auto px-4">
        <div className="navbar-box flex items-center justify-between">
          <div className="logo">
            <h1 className="sm:text-2xl text-xl font-bold">MyPortFolio</h1>
          </div>
          <ul className= {`flex lg:gap-12 md:static md:flex-row md:shadow-none md:bg-transparent md:w-auto md:h-full md:translate-y-0 md:text-black md:p-0 md:m-0 md:transition-none gap-8 fixed ${menuActive} top-1/2 -translate-y-1/2 flex-col px-8 py-6 rounded shadow-lg shadow-slate-300 bg-green-600 font-bold text-white transition-all`} >
            ...
            <i className="ri-settings-3-line text-3xl md:hidden block"></i>
              <a href="#services"className="font-medium opacity-75">Skills</a>
            </li>
            <li className="flex items-center gap-3">
          ...
          <div className="social flex items-center gap-2">
            <a href="#social" className="bg-green-700 px-5 py-2 rounded-full text-white font-bold hover:bg-green-600 transition-all">Contact Me</a>
